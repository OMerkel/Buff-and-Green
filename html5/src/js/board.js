...
Board.prototype.generateRedActionsKing = function( capture, move, pos ) {
  for(var d=0; d<4; ++d) {
...
Board.prototype.generateWhiteActionsKing = function( capture, move, pos ) {
  for(var d=0; d<4; ++d) {
    direction = Board.DIRECTION[d];
    if ( Board.DIAGONALS[pos][direction].length > 0 ) {
      var obstacles = 0;
