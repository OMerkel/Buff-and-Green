# UCT / MCTS Engine – Buff and Green

This document describes the currently implemented AI engine in the Buff and Green (American Checkers) project:
...
Red-side difficulty, White-side difficulty, and device profile are selected in UI
...
- active player 1 (White/North) -> `difficultyNorth`
